...
req = Request('https://fourminutebooks.com/best-self-help-books', headers={'User-Agent': 'Mozilla/5.0'})
...
data={
    ...
    'authors':authors,
    'quotes':quotes,
    'The Book in One Sentence':the_book_in_one_sentence,
    'Why should you read it?':why_should_you_read_it,
