...
while (ei<total):
	...
	photolocation="images/"+id_list[ei]+".png"


	filenamess=name_list[ei].strip()+" - "+email_list[ei].strip()+".png"

	font = ImageFont.truetype("BwGlennSansDEMO-ExtraBoldItalic.otf", 48)
	font2 = ImageFont.truetype("BwGlennSansDEMO-LightItalic.otf", 28)
